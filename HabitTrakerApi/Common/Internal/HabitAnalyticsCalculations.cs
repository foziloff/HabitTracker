...
namespace HabitTrakerApi.Analytics.Internal;

// ВАЖНО: этот класс internal — он больше не публичный API.
// Раньше это был Common/HabitAnalyticsHelper.cs, который дёргали напрямую из сервисов.
// Теперь единственная точка входа в расчёты — CQRS-запросы из Analytics/Queries,
// которые внутри себя используют этот класс. Сама математика не изменилась.
internal static class HabitAnalyticsCalculations
{
